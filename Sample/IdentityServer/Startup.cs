...
using QuickstartIdentityServer412;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var builder = services.AddIdentityServer(options =>
                ...
                //.AddInMemoryClients(Clients.Get()) // [Original code]
                //.AddInMemoryIdentityResources(Resources.IdentityResources) [Original code]
                //.AddInMemoryApiScopes(Resources.ApiScopes) // [Original code]
                ...
                .AddProfileService<HostProfileService>() // Upgraded for LDAP (see class for details).
